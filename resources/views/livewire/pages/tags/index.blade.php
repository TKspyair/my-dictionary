...
<div class="container-fluid" x-data="{ tagCreateMode: false , showTagModal: false}" >

    <!--モーダルを開くボタン-->
    <span x-on:click="showTagModal = true">設定</span>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                @else
                                    ...
                                    <span class="d-flex align-items-center flex-grow-1" wire:click="switchEdit({{ $tag->id }})">
                                        <i class="bi bi-tag-fill me-2"></i> {{ $tag->tag_name }}
                                    </span>
                                @endif
                            </li>
                        @endforeach
